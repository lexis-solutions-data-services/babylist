"""
Example: How to call the babylist actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/babylist
...
def run_actor():
    """Run the babylist actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/babylist"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.babylist.com/store/search?order=asc&search_term=baby"}],
            "maxItems": 20,
